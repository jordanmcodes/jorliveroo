...
## User Stories
The user stories for the Jorliveroo food delivery application were created with MoSCoW methodology in mind. These user stories helped with the design process of the application, clearly identifying the customer's journey, while simultaneously helping the admin team tackle any required adjustments.
### Category buttons
* **As a user:** Customer
